...
```
 ...
 A2.33 (5 points), A2.36. (3 points each)
...
Partial contingency tables. We need to group the rows by defendent race to hold the race of victim constant.

```{r}
# Victim white:
defendent_white <- matrix(c(151.5, 63.5,9.5, 103.5,(151.5 + 9.5),(63.5 + 103.5), 19.5, 11.5,0.5,6.5, (19.5+0.5), (11.5+6.5)), ncol=2) 
colnames(defendent_white) <- c('No Death Penalty', "Death Penalty") 
rownames(defendent_white) <- c('White Killed White', 'Black Killed White',"White Killed Black", "Black Killed Black", "Total: Def. White", "Total: Def. Black") 
