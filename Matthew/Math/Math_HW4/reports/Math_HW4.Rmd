...
**Answer:**\newline
$\dfrac {e^{\sqrt y}} {2 \sqrt y}.$

**Work:**\newline
$$k(y) = e^{\sqrt{y}}.$$
Identify the layers:\newline
$$k(y) = e^A, \ A = \sqrt y$$
Get the derivative of each:\newline
$$\dfrac {d} {dy}(\sqrt{y}) = \dfrac {1} {2 \sqrt y }.$$
$$\dfrac {d} {dA} (e^A) = e^A$$
Sub back in:
$$e^A \dfrac {1} {2 \sqrt y},$$
$$= \dfrac {e^{\sqrt y}} {1} \times \dfrac {1} {2 \sqrt y},$$
$$\dfrac {e^{\sqrt y}} {2 \sqrt y} = k'(y).$$
...
**Answer:**\newline
$(\sqrt y + 1) \dfrac {e \sqrt y} {2 \sqrt y}$

**Work:**\newline

$$\textrm{if} \ n(y) = \sqrt y e^{\sqrt y}, \ \textrm{then}$$
$$n'(y) = f'(y)g(y) + g'(y)f(y),$$
$$\textrm {where} \ f(y) = \sqrt y \ \  \textrm {and} \ \  g(y) = e^{\sqrt y}.$$

#### Derivative of f(y):
$$f'(y) = \dfrac {d} {dy} (\sqrt y)= \dfrac {1} {2 \sqrt y}.$$
#### Derivative of g(y):
Identify the layers:
$$g(y) = e^A, \ A = \sqrt P,$$

##### First layer:
$$\dfrac {d} {dA} (e^A) = e^A = e^\sqrt y.$$

##### Second layer:
$$\dfrac {d} {dy} (\sqrt y ) = \dfrac {1} {2 \sqrt y}.$$

#### Multiply:
$$g'(y) = e^{\sqrt y } \times \dfrac {1} {2 \sqrt y},$$
$$ = \dfrac {e^{\sqrt y }} {1}  \times \dfrac {1} {2 \sqrt y}$$
$$ = \dfrac {e^{\sqrt y }} {2 \sqrt y}.$$

#### Substitute:

$$n'(y) = \Big( \dfrac {1} {2 \sqrt y}\Big) \Big( e^{\sqrt y} \Big) + \Big(\dfrac {e^{\sqrt y}} {2 \sqrt y}  \Big) \Big(\sqrt y  \Big),$$
$$ = (\sqrt y + 1) \dfrac {e \sqrt y} {2 \sqrt y} .$$
